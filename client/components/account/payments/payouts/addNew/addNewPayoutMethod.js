                ...
                <View style={styles.container}>
                    <View style={styles.margin}>
                        ...
                        <List>
                            ...
                            <Left>
                                <NativeText numberOfLines={3}><NativeText style={{ color: "#0057ff", fontWeight: "bold" }}>Bank Transfer</NativeText> {"\n"}- Get paid in 5-7 business days {"\n"}- No fees</NativeText>
                            </Left>
                            <Right>
                            ...
                            <Left>
                                <NativeText numberOfLines={3}><NativeText style={{ color: "#0057ff", fontWeight: "bold" }}>Paypal</NativeText> {"\n"}- Get paid in 3-4 hours {"\n"}- May include fees</NativeText>
                            </Left>
                            <Right>
                                <Icon name="arrow-forward" />
                            </Right>
                            ...
                            <ListItem button={true} onPress={() => {}} style={styles.listitem}>
                            <Left>
                                <NativeText numberOfLines={3}><NativeText style={{ color: "#0057ff", fontWeight: "bold" }}>Mechanic2Day Cash Card</NativeText> {"\n"}- Get paid instantly {"\n"}- May include fees</NativeText>
                            </Left>
                            <Right>
                                <Icon name="arrow-forward" />
                            </Right>
