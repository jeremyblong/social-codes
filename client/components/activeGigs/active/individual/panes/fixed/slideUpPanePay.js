...
const SlideUpPaymentHelper = ({ sheetRef, rate, unique_id, job, withID, paymentCompletedFull, paymentCompletedPartial }) => {
    ...
    const handleCustomPaymentSubmission = () => {
        
        axios.post(`${Config.ngrok_url}/make/custom/payment/one`, {
            rate: customPayment,
            id: unique_id,
            date: job.date,
            jobID: job.jobID,
            ...
            if (res.data.message === "Made CUSTOM payment!") {
                console.log(res.data);
        ...
        <RBSheet
            ...
            <View style={styles.container}>
                ...
                <View style={styles.subContainer}>
                    ...
                    {customPayment !== null ? <AwesomeButtonCartman style={{ marginTop: 15 }} onPress={handleCustomPaymentSubmission} type={"anchor"} stretch={true} textColor={"white"}>Submit Payment</AwesomeButtonCartman> : <AwesomeButtonCartman style={{ marginTop: 15 }} type={"disabled"} stretch={true} textColor={"white"}>Submit Payment</AwesomeButtonCartman>}
