                            ...
                            return (
                                <ListItem key={index} avatar>
                                    ...
                                    <Body>
                                        ...
                                        <Text note>Social Codes has taken an application fee of <Text style={{ fontWeight: "bold", color: "darkred" }}>${(payment.application_fee_amount / 100).toFixed(2)}</Text></Text>
                                    </Body>
                                    <Right>
