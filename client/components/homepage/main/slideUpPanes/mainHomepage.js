                ...
                <View style={styles.container}>              
                    {ready === true ? <FlatList   
                        ListHeaderComponent={() => {
                            return (
                                <Fragment>
                                    <Header style={{ borderBottomColor: "transparent", backgroundColor: "lightgrey" }}>
                                        <Left>
                                            <Button transparent>
                                        ...
                                        <Right style={{ position: "absolute", right: -15 }}>
                                            ...
                                            <Button button={true} onPress={() => {
                                                ...
                                                <Image source={require("../../../assets/icons/chat.png")} style={styles.maxedIcon} />
                                            </Button>
                                        </Right>
                                    </Header>
                                    <Footer style={{ borderColor: "transparent" }}>
                                        <FooterTab style={{ backgroundColor: "#fdd530" }}>
                                            <Button style={{ backgroundColor: "lightgrey" }} active>
                                    ...
                                    <View style={styles.row}>
                                        ...
                                        <TouchableOpacity onPress={() => {
                                            ...
                                            <View style={{ height: 45, borderColor: 'gray', borderWidth: 1, borderRadius: 25, maxWidth: "90%", marginBottom: 5, paddingLeft: 15 }} >
                                                <Text style={{ marginTop: 12, fontSize: 15 }}>What's on your mind?</Text>
                                            </View>
                                        </TouchableOpacity>
                                    </View>
                                    <Footer style={Platform.OS === "ios" ? { borderColor: "transparent", backgroundColor: "#fdd530" } : { borderColor: "transparent" }}>
                                        <FooterTab>
                                            <Button style={styles.greyButton}>
                                                <View style={styles.row}>
                                                    <Image source={require("../../../assets/icons/video-on.png")} style={[styles.maxedIconSmallTwo, { tintColor: "black" }]} />
                                                    <Text style={styles.iconText}>Go Live</Text>
                                                </View>
                                            </Button>
                                            <Button style={styles.greyButton}>
                                                <View style={styles.row}>
                                                    <Image source={require("../../../assets/icons/gallery.png")} style={[styles.maxedIconSmallTwo, { tintColor: "black" }]} />
                                                    <Text style={styles.iconText}>Photo</Text>
                                                </View>
                                            </Button>
                                            <Button style={styles.greyButton}>
                                                <View style={styles.row}>
                                                    <Image source={require("../../../assets/icons/job.png")} style={[styles.maxedIconSmallTwo, { tintColor: "black" }]} />
                            ...
                            if (_.has(post, "newData") && post.shared === true) {
                                ...
                                <Card>
                                    ...
                                    <CardItem style={{ width: width, marginLeft: -20 }}>
                                        <Body>
                                            <Footer style={{ width: width, backgroundColor: "#fdd530" }}>
                                                                    ...
                                                                    {post.peopleReactedIDs.includes(this.props.unique_id) ? <Popover  
                                                                        ...
                                                                        from={(
                                                                            <Button onPress={() => {
                                                                                ...
                                                                                <Image source={require("../../../assets/icons/like.png")} style={{ maxWidth: 20, maxHeight: 20, tintColor: "black", backgroundColor: "#fdd530" }} />
                                                                                <Text style={{ color: "blue", fontWeight: "bold" }}>Un-Like</Text>
                                                                            </Button>
                                                                        )}>
                                                                        <View style={styles.popoverTwo}>
