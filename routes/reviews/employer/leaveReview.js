...
mongo.connect(config.get("mongoURI"),  { useNewUrlParser: true }, { useUnifiedTopology: true }, cors(), (err, db) => {
    router.post("/", (req, resppppp) => {
        ...
        collection.findOneAndUpdate({ unique_id: otherUser }, { $push: { reviews: {
            skillsOfFreelancer: freelancerSkillStar,
            overallExperience: overallReviewStar,
            meetOrExceedExpectations: expectationSkillStar,
            completedProjectSuccessfully: completedProjectSuccessfullyStar,
            spokeProperLanguage: languageSkillStar,
            wouldHireAgain: hireAgainSkillStar,
            wouldRecommend: colleagueRecommendStarSkill,
                    ...
                    if (userrr) {
                        ...
                        for (let index = 0; index < userrr.completedProjects.length; index++) {
                            ...
                            if (gig.id === project.id) {
                                ...
                                project["employerLeftReview"] = true;
