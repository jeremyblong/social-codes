                ...
                if (account) {
                    ...
                    const token = await stripe.tokens.create({
                        ...
                        if (err) {
                            ...
                            const bankAccount = await stripe.accounts.createExternalAccount(user.stripeConnectAccount.id, { external_account: createdToken.id }, (error, account) => {
                                if (error) {
                                    console.log(error);
